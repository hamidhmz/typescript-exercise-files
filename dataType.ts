...
let functionVariable1: (a: number, b: number, cb: (num: number) => void) => String;   // just function who have two input parameters and one callback function and string return type
